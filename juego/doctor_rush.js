...
// *** AUDIO*** //
const audioShoot = new Audio('juego/assets/audio/bullet.wav')
const audioZombieDie = new Audio('juego/assets/audio/zombie_die.wav')
const audioMusic = new Audio('juego/assets/audio/background_music.mp3')
const audioGameOver = new Audio('juego/assets/audio/game-over.mp3')
const audioCoin = new Audio('juego/assets/audio/coin.mp3')
...
function setZombieSkin(zombie) {
  ...
  zombie.style.backgroundImage = `url("juego/assets/pkm_${i}.png")`
}
...
function shoot(event) {
  ...
  var moveBullet = setInterval(moveBulletXY, 60)
}
